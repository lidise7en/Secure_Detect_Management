...
<body bgcolor="#ADD8E6">
<div align="center"><h3>安全检测业务列表</h3></div>
<br>
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bgcolor="#BBD3EB">
		...
		<s:iterator value="#request.serviceList" id="outter">
   		<tr>
   			<td align="center"><a href="${pageContext.request.contextPath}/serviceInfoAction?id=${outter.id}"><s:property value="serviceName"/></a></td>
